...
export class SnapshotManager {
   ...
   * 保存快照
   */
  async saveSnapshot(filePath: string, content: string, idempotencyKey?: string): Promise<string> {
   ...
   */
  async listSnapshots(options?: { limit?: number; path?: string }): Promise<SnapshotMetadata[]> {
